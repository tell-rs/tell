//! Tail command - Live streaming CLI for collector
//!
//! Connect to a running collector and stream batches in real-time.
...
use cdp_protocol::{decode_event_data, decode_log_data, FlatBatch, LogLevel};
use tap::{SubscribeRequest, TapEnvelope, TapMessage};
